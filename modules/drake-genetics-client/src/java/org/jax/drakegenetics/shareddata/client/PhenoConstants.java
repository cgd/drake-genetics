...
public final class PhenoConstants {

    // String constants for phenotype categories
    ...
    public static final String CAT_BREATH = "Breath";
    ...
    public static final String COLOR_FROST = "frost";
    public static final String COLOR_TAWNY = "tawny";
    public static final String COLOR_ARGENT = "argent";
    public static final String COLOR_STEEL = "steel";
    public static final String COLOR_COPPER = "copper";
    public static final String COLOR_CHARCOAL = "charcoal";
    public static final String COLOR_DUST = "dust";
    ...
    public static final String SEX_F_SCRUFFY = "scruffy female";
    
    public static final String DIABETES_PREDISP = "predisposition for diabetes";
    public static final String DIABETES_NOPREDISP = "no predisposition for diabetes";
